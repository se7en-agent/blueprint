...
10. Do not add a final-answer writeback block. Routine blueprint syncs usually do not update wiki or story unless the sync captured an operating-model change or public milestone; the scheduled `hourly-writeback-review` job handles broader promotion.
